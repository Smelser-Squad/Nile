...
import {
  EMAIL_MAX_LENGTH, NAME_MAX_LENGTH, NAME_MIN_LENGTH,
...
class SignUp extends Component {
  ...
  handleSubmit(event) {
    ...
    signup(signupRequest)
      .then((response) => {
        this.props.enqueueSnackbar('User registered successfully!', { variant: 'success', anchorOrigin: { vertical: 'bottom', horizontal: 'center' } });
        this.props.history.push('/signin');
      }).catch((error) => {
        this.props.enqueueSnackbar('Something went wrong!', { variant: 'error', anchorOrigin: { vertical: 'bottom', horizontal: 'center ' } });
      });
  }
  ...
  render() {
    ...
    return (
      <Container component="main" maxWidth="xs" ref={this.ref}>
